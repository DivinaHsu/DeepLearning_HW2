...
def test_logging(logger: tb.SummaryWriter):
    ...
    for epoch in range(10):
        ...
        for iteration in range(20):
            ...
            # TODO: log train_loss
            logger.add_scalar("train_loss", dummy_train_loss, global_step)  # <<< ADDED

            # TODO: save additional metrics to be averaged
            metrics["train_acc"].append(dummy_train_accuracy.mean().item())  # <<< ADDED
        ...
        for _ in range(10):
            ...
            # TODO: save additional metrics to be averaged
            metrics["val_acc"].append(dummy_validation_accuracy.mean().item())  # <<< ADDED
